...
//  CheckUpEmployee
//
//  Created by Hassan Khamis on 6/14/20.
...
//        gradient.colors = [UIColor(red: 131/255, green: 234/255, blue: 241/255, alpha: 1).cgColor, #colorLiteral(red: 0.3882352941, green: 0.6431372549, blue: 1, alpha: 1).cgColor]
        gradient.colors = [#colorLiteral(red: 0.03529411765, green: 0.7411764706, blue: 0.9764705882, alpha: 1).cgColor, #colorLiteral(red: 0, green: 0.737254902, blue: 0.9725490196, alpha: 1).cgColor]
